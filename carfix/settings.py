...
ALLOWED_HOSTS = [ 'localhost' ,  'fixcars.ro' , 'www.fixcars.ro'  ,'10.0.2.2'  , '192.168.1.129' , '127.0.0.1' , '157.180.127.178' ,'app.fixcars.ro', 'www.app.fixcars.ro' ]
...
# Email Configuration gmail un comment it in case you want to use gmail to send emails
# EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
